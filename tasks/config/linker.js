...
module.exports = function(grunt) {
	...
	grunt.config.set('linker', {
		'devJs': {
			'files': {
				'dist/assets/js/vendor': require('../pipeline').jsFilesToInject
			}
		},
		'devJsIE': {
			'options': {
			...
			'files': {
				'dist/assets/js/vendor': require('../pipeline').jsIEFilesToInject
			}
		},
		'devJsIE8': {
			'options': {
			...
			'files': {
				'dist/assets/js/vendor': require('../pipeline').jsIE8FilesToInject
			}
		},
		'devCss': {
			'options': {
				...
				'as': 'assets/css/vendor'
			},
			'files': {
				'dist/assets/css/vendor': require('../pipeline').cssFilesToInject
			}
		}
	});
